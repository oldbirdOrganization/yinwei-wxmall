...
module.exports = {
  ...
  GoodsDetail: API_BASE_URL + "goods/goodsDetail", //商品详情页
  SubmitOrder: API_BASE_URL + "orderInfo/submitOrder", //下单
  Upload: API_BASE_URL + "upload/upload", //上传

  IndexUrlBanner: API_BASE_URL + "index/banner", //首页banner
  IndexFLoorGoods: API_BASE_URL + "index/floorGoods",
  TopicCase: API_BASE_URL + "index/topicCase", //案例列表

  UserInfo: API_BASE_URL + "user/queryUserInfo", //获取用户信息
  UserLevel: API_BASE_URL + "user/getUserLevel",
  ...
  DesignateOrder: API_BASE_URL + "orderInfo/designateingOrderList", //待确认订单
  ConfirmOrder: API_BASE_URL + "orderInfo/confirmingOrderList", //待确认订单
  FinishOrder: API_BASE_URL + "orderInfo/finishOrderList", //完成订单
  PaymentOrder: API_BASE_URL + "orderInfo/paymentingOrderList", //待付款订单
  OrderDetail: API_BASE_URL + "orderInfo/detail", //订单详情
  OrderSubmit: API_BASE_URL + "orderInfo/submitOrder", // 提交订单
  PayPrepayId: API_BASE_URL + "orderPay/prepay", //获取微信统一下单prepay_id
  ...
  MyCouponList: API_BASE_URL + "user/queryUserCoupon", //获取个人优惠券列表
